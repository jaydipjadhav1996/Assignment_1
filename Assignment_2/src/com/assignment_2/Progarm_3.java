...
/*Create Class STudent which will have following class members: - rollno, accountno, custname, cust_address, cust_dob, cust_account_opening_date, Branch_Obj. 
...
deposit and withdrawal the amount. So you need to print the statement as per the CustomerId.
...
public class Progarm_3 {
	public static void main(String[] args) {
		System.out.println("First ");
		Branch branch = new Branch(101, "SBI", "Gadge Nagar Amravati");
		System.out.println(branch);
		Student std = new Student(1, 132123, "Mayur", "Katraj Pune", LocalDate.of(1997, 12, 12),
				LocalDate.of(2022, 10, 2), branch);
		System.out.println(std);
		Customer_Account_Statements cas = new Customer_Account_Statements(123, 123213, 10000, 2456,
				LocalDate.of(2022, 11, 2), std, branch);
		System.out.println(cas);
		System.out.println("");
		System.out.println("Second ");
		Branch branchOne = new Branch(104, "SBI", "Gadge Nagar Amravati");
		System.out.println(branchOne);
		Student stdOne = new Student(3, 132344, "Vedant", "Mundhawa Pune", LocalDate.of(1997, 11, 1),
				LocalDate.of(2022, 10, 12), branchOne);
		System.out.println(stdOne);
		Customer_Account_Statements casOne = new Customer_Account_Statements(133, 123213, 10000, 3356,
				LocalDate.of(2022, 11, 2), stdOne, branchOne);
